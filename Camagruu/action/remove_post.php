...
if (isset($_SESSION['user']) &&  $_SESSION['user'] != '' && isset($_GET['token']) && if_gallery_of_you(base64_decode($_GET['token']), $pdo) == $_SESSION['user'] && isset($_SESSION['token_index']) && $_GET['token_index'] == $_SESSION['token_index']) {
